...
require(ggtree)
tree <- read.tree("https://github.com/bkatati/adiversity/PhyloFlavi.nwk")
# Note: if you have error with path, download file(s) to your PC.
tree
...
traits2 <- read.csv("https://github.com/bkatati/adiversity/traits.csv")
# Note: if you have error with path, download file(s) to your PC.
